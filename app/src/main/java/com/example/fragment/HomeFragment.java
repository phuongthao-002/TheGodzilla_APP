...
import com.example.thegodzilla_app.Search_keyword;
...
public class HomeFragment extends Fragment {
    ...
    View.OnClickListener OpenAllProducts, OpenSearch;
    ...
    private void addEvent() {
        ...
        OpenSearch = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), Search_keyword.class));
            }
        };
        imbSearch.setOnClickListener(OpenSearch);
